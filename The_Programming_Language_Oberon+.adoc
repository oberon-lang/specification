...
[NOTE]
In contrast to previous Oberon versions the return type of a procedure may also be a record or array type.
...
// proc () (args) would actually be the more intuitive syntax, but it is ambiguous with an empty/missing parameter list
